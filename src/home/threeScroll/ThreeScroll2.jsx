...
const ThreeScroll2 = () => {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      if (xPercent <= -124.4) xPercent = 0;
      if (xPercent > 0) xPercent = -124.4;
  ...
  return (
    <div className="w-screen bg-[#D3D3FF] -translate-y-5 transform overflow-hidden h-55 flex items-center">
