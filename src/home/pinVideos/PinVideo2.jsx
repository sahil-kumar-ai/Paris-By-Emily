...
const PinVideo2 = () => {
  ...
  return (
    <div className="w-screen transform translate-y-28 relative h-[70vh] flex justify-center items-center">
      <div className="relative top-12 h-[80vh] w-[88vw]">
        ...
        <div className="absolute flex flex-col bottom-12 left-10">
          <div className="bg-[#D3D3FF] h-11 w-38 flex flex-col justify-center">
          ...
          <div className="mt-4">
            <h1 className="text-white font-[Bold] text-7xl">
              Croissant-Making <br /> Workshop
            </h1>
          </div>
          <div className="mt-4">
            <div className="bg-[#DEDEFF] inline-block rounded-full h-11 w-30">
