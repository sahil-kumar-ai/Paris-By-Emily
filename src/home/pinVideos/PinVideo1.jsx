...
const PinVideo1 = () => {
  ...
  return (
    <div className="w-screen top-5 relative h-[70vh] flex justify-center items-center">
      <div className="relative top-12 h-[80vh] w-[88vw]">
        ...
        <div className="absolute flex flex-col bottom-12 left-10">
          <div className="bg-[#FF7782] h-11 w-38 flex flex-col justify-center">
            <h1 className="font-[Regular2] tracking-wide text-center text-4xl">
              Walking Tours
            </h1>
          </div>
          <div className="mt-4">
            <h1 className="text-white font-[Bold] text-7xl">
              Walk in the <br /> footsteps of Emily
            </h1>
          </div>
          <div className="mt-4">
            <div className="bg-[#FF99A1] inline-block rounded-full h-11 w-30">
          ...
          <div ref={viewExpAll} className="flex flex-row relative">
            ...
            >
              <i
                ...
                className="bg-[#D3D3FF] h-15 w-15 rounded-full flex justify-center items-center"
              >
