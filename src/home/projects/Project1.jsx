  ...
  return (
    <div>
      ...
      <div ref={main} className="h-48 relative flex justify-center flex-col">
        <div
          ref={mainSec}
          className="flex justify-between w-[93vw] h-49 transform translate-x-13.5"
        >
          <div className="flex transform translate-y-5.5">
            <div
              ref={img}
              className="h-26 w-26 scale-[0] transform origin-left translate-y-7 flex absolute flex-col justify-center"
            >
              <img src="./public/images/cake.avif" alt="" />
            </div>
            <div ref={longText}>
              <div>
                <h1 className="font-[regular] text[#1A1A1A] text-[58px] ">
                  Walk in the footsteps of Emily
                </h1>
              </div>
              <div ref={chunks} className="flex text-[#1A1A1A]">
                <div className="border w-45 flex flex-col justify-center rounded-full h-12">
                  <h1 className="font-[REGULAR2] relative top-0.5 text-center text-[37px] tracking-[0.5px] ">
                    WALKING TOURS
                  </h1>
                </div>
          ...
          <div className="flex flex-col justify-center">
            <div
              ref={circleArrow}
              className="rounded-full h-17 w-17 border flex justify-center items-center"
            >
              <i ref={arrow}>
                <RiArrowRightUpLongLine className="w-8 h-8" />
              </i>
            </div>
          </div>
        </div>
